...
const NewQueue: React.FC = () => {
    ...
    return (
        <div className='new-queue'>
            ...
            <div className="new-queue__container">
                <div className="row heading">Cấp số mới</div>
                <div className="row">Dịch vụ khách hàng đã chọn</div>
                <div className="row"><Select options={serviceList} /></div>
                <div className="row buttons">
                    <Button text='Huỷ bỏ' isOutlined onClick={() => { navigate("/dashboard/queue/list") }} />
                    <Button text='In số' onClick={() => { setModal(prev => !prev) }} />
                </div>
            </div>
            {modal && <Modal>
                <div className="new-queue-number">
                    <div className="number-top">
                        <div className='number-top__icon' onClick={() => { setModal(prev => !prev) }}><XmarkIc /></div>
